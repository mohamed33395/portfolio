...
export default function AboutPage() {
    ...
    return (
        <Box sx={{ minHeight: '100vh', bgcolor: currentTheme === 'dark' ? '#1e293c' : '#f5f5f5', py: 8, px: { xs: 3, md: 6 }, transition: 'background-color 0.3s' }}>
            ...
            <Box sx={{ maxWidth: 1100, mx: 'auto', display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 5, alignItems: 'flex-start' }}>
                ...
                <Box sx={{ flexShrink: 0, width: { xs: '100%', md: 300 }, display: 'flex', flexDirection: 'column', gap: 3 }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                        {infoItems.map((item, i) => (
                            <Box key={i} sx={{ display: 'flex', alignItems: 'center', gap: 2, bgcolor: currentTheme === 'dark' ? '#8e99a5' : '#fff', px: 2, py: 1.5, borderRadius: 2, boxShadow: '0 1px 6px rgba(0,0,0,0.05)', transition: 'all 0.2s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.1)', transform: 'translateX(4px)' } }}>
                ...
                <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', gap: 4 }}>
                    ...
                    <Box>
                        ...
                        <Box sx={{ bgcolor: currentTheme === 'dark' ? '#8e99a5' : '#fff', borderRadius: 3, p: 3, boxShadow: '0 2px 12px rgba(0,0,0,0.05)' }}>
                    ...
                    <Box>
                        ...
                        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 2 }}>
                            {[
                                ...
                                <Box key={i} sx={{ display: 'flex', gap: 2, bgcolor: currentTheme === 'dark' ? '#8e99a5' : '#fff', borderRadius: 3, p: 2.5, boxShadow: '0 2px 10px rgba(0,0,0,0.05)', transition: 'all 0.3s', '&:hover': { transform: 'translateY(-4px)', boxShadow: '0 8px 24px rgba(0,0,0,0.10)' } }}>
                    ...
                    <Box>
                        ...
                        <Box sx={{ bgcolor: currentTheme === 'dark' ? '#8e99a5' : '#fff', borderRadius: 3, p: 3, borderLeft: `4px solid ${primary}`, boxShadow: '0 2px 12px rgba(0,0,0,0.05)' }}>
                            <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 2 }}>
                                {locale === 'en'
