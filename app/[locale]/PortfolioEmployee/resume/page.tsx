...
export default function ResumePage() {
    ...
    return (
        <Box sx={{ minHeight: '100vh', bgcolor: currentTheme === 'dark' ? '#1e293c' : '#e6e8e7', py: 8, px: { xs: 3, md: 6 }, transition: 'background-color 0.3s' }}>
            ...
            <Box sx={{ maxWidth: 1100, mx: 'auto', display: 'flex', flexDirection: 'column', gap: 7 }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                        {data.resume.qualifications.map((q, i) => (
                            <Box
                                key={i}
                                sx={{
                                    bgcolor: currentTheme === 'dark' ? '#8e99a5' : '#ffffff',
                                    borderRadius: 3,
                                    p: 3,
                                    display: 'flex',
                                    gap: 3,
                ...
                <Box>
                    <SectionHeader
                        ...
                        primary={primary}
                    />
                    <Box sx={{ bgcolor: currentTheme === 'dark' ? '#8e99a5' : '#fff', borderRadius: 3, p: 4, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', borderLeft: `4px solid ${primary}` }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                        {data.resume.experience.map((exp, i) => (
                            <Box
                                key={i}
                                sx={{
                                    bgcolor: currentTheme === 'dark' ? '#8e99a5' : '#fff',
                                    borderRadius: 3,
                                    p: 3,
                                    boxShadow: '0 2px 12px rgba(0,0,0,0.06)',
                                    transition: 'all 0.3s',
                            ...
                            >
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 1, mb: 1 }}>
                                    ...
                                    <Box sx={{ bgcolor: primary, px: 2, py: 0.5, borderRadius: 10, alignSelf: 'flex-start' }}>
                                        <Typography variant="caption" sx={{ fontWeight: 700, color: '#1a274a' }}>
